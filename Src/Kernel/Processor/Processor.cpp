...
BOOL
GProcessor::RegInterrupt(INT x, IsrHandler isr)
{
	SetVector(x, isr);
	return true;
}
...
BOOL
GProcessor::SetTimerFreq(UINT freq)
{
...
BOOL
GProcessor::GetProcessorInfo(const CHAR *info, VOID *result)
{
...
BOOL
GProcessor::GetProcessorFeature(const CHAR* feature)
{
...
UINT
GProcessorInfo::GetProcessorFamilyCode() const
{
	return m_u_FamilyCode;
}

UINT
GProcessorInfo::GetProcessorModelNumber() const
{
	return m_u_ModelNumber;
}

UINT
GProcessorInfo::GetProcessorSteppingId() const
{
	return m_u_SteppingId;
}

UINT
GProcessorInfo::GetProcessorType() const
{
	return m_u_ProcessorType;
}

UINT
GProcessorInfo::GetProcessorCores() const
{
	return m_u_Cores;
}

UINT
GProcessorInfo::GetProcessorExtFamily() const
{
	return m_u_ExtFamily;
}

UINT
GProcessorInfo::GetProcessorExtModel() const
{
	return m_u_ExtModel;
}

UINT
GProcessorInfo::GetProcessorApicId() const
{
	return m_u_ApicId;
}

UINT
GProcessorInfo::GetProcessorBrandId() const
{
	return m_u_BrandId;
}
...
BOOL
GProcessorInfo::GetProcessorFeature(const CHAR* feature)
{
	return false;
}

VOID
GProcessorInfo::DO_INTEL()
{
