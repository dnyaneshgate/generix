...
void __ctors()
{
	extern int(*start_ctor)();
	extern int(*end_ctor)();
	int (**constructor)();
	for(constructor=&start_ctor;constructor<&end_ctor;constructor++){
		(*constructor)();
	}
}
...
void __dtors()
{
	extern int(*start_dtor)();
	extern int(*end_dtor)();
	int (**destructor)();
	for(destructor=&start_dtor;destructor<&end_dtor;destructor++){
		(*destructor)();
	}
}
*/
