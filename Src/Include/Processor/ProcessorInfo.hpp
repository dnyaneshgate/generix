...
struct IntelBrandIndexString {
	...
	IntelBrandIndexString(const UINT b, const UINT s, const char* t) :
			brand(b), signature(s), text(t) {
	}
...
STATIC CONST IntelBrandIndexString intel_brand_index_list[] =
		{
				IntelBrandIndexString(0x00, 0x0000,
						"This processor does not support the brand identification feature"),
				IntelBrandIndexString(0x00, 0x06EC,
						"Intel CoreTM Duo processor"), IntelBrandIndexString(
						0x01, 0x0000, "Intel Celeron processor"),
				IntelBrandIndexString(0x02, 0x0000,
						"Intel Pentium III processor"), IntelBrandIndexString(
						0x03, 0x0000, "Intel Pentium III XeonTM processor"),
				IntelBrandIndexString(0x03, 0x06B1, "Intel Celeron processor"),
				IntelBrandIndexString(0x04, 0x0000,
						"Intel Pentium III processor"), IntelBrandIndexString(
						0x06, 0x0000, "Mobile Intel Pentium III processor-M"),
				IntelBrandIndexString(0x07, 0x0000,
						"Mobile Intel Celeron processor"),
				IntelBrandIndexString(0x08, 0x0000,
						"Intel Pentium 4 processor"), IntelBrandIndexString(
						0x09, 0x0000, "Intel Pentium 4 processor"),
				IntelBrandIndexString(0x0a, 0x0000, "Intel Celeron processor"),
				IntelBrandIndexString(0x0b, 0x0000, "Intel XeonTM processor"),
				IntelBrandIndexString(0x0b, 0x0F13,
						"Intel XeonTM processor MP"), IntelBrandIndexString(
						0x0c, 0x0000, "Intel XeonTM processor MP"),
				IntelBrandIndexString(0x0e, 0x0000,
						"Mobile Intel Pentium 4 processor-M"),
				IntelBrandIndexString(0x0e, 0x0F13, "Intel XeonTM processor"),
				IntelBrandIndexString(0x0f, 0x0000,
						"Mobile Intel Celeron processor"),
				IntelBrandIndexString(0x13, 0x0000,
						"Mobile Intel Celeron processor"),
				IntelBrandIndexString(0x16, 0x0000, "Intel Pentium M processor") };

struct AMD_BrandIndexString {

	AMD_BrandIndexString(const UINT f, const UINT m, const char* t) :
			family(f), model(m), text(t) {
	}
